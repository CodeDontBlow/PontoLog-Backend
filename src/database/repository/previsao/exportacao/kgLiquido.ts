...
export default class KgLiquidoProphetRepository {
  private repository: Repository<kgLiquidoExportacao>;

  constructor() {
    this.repository = AppDataSource.getRepository(kgLiquidoExportacao);
  }
  ...
  public async getPrevisoesByYear(
    ...
    const key = getKey("KgLiquido", "getPrevisoesByYear", { year });
