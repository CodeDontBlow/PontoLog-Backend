...
export default class VlAgregadoProphetRepository {
  private repository: Repository<vlAgregadoExportacao>;

  constructor() {
    this.repository = AppDataSource.getRepository(vlAgregadoExportacao);
  }
  ...
  public async getPrevisoesByYear(
    ...
    const key = getKey("vlAgregado", "getPrevisoesByYear", { year });
