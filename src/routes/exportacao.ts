...
router.get(
  ...
  expResController.getVlAgregadoByYearRangeAndProduct("Valor Agregado de ano até ano por produto."),
);
...
router.get(
  ...
  expResController.getKgLiquidoByYearRangeAndProduct("Kg líquido de ano até ano por produto."),
);
